...
//stargate
import stargateSource from "../models/stargate/stargate.glb";
// spacestation
import spaceStation from "../models/spacestation/spacestation.glb";
...
export default class Resources extends EventEmitter {
  constructor() {
    ...
    this.loader.load([
      ...
      { name: "spacestation", source: spaceStation },
      { name: "stargate", source: stargateSource },
    ]);
  }
}
